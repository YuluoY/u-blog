...
export class Users {
	...
	@Column({ type: 'varchar', length: 255, nullable: false, comment: '密码（AES加密）' })
	...
	@Column({ name: 'isActive', select: false, type: 'boolean', default: true, comment: '账号是否激活' })
